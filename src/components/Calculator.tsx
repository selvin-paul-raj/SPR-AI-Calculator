...
const Calculator = () => {
    ...
    return (
        ...
        <div className="flex ">
           ...
           <a href='https://github.com/selvin-paul-raj' target='_blank' className='text-start title z-50 w-full  px-4  text-xl md:text-6xl font-extrabold mt-2  md:text-center'>SPR&apos;s AI Calculator</a>
           {/* add undo & redo  */} 
